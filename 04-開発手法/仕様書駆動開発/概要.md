...
| フェーズ | 目的 | 成果物 | 詳細 |
|---|---|---|---|
| 1. Requirements | **何を作るか**を定義 | `requirements.md` | [01-要件定義/ガイド.md](./01-要件定義/ガイド.md) |
| 2. Design | **どう作るか**を設計 | `design.md`, `data-model.md`, `contracts/` | [02-設計/ガイド.md](./02-設計/ガイド.md) |
| 3. Tasks | **どう分割するか**を計画 | `tasks.md` | [03-タスク分割/ガイド.md](./03-タスク分割/ガイド.md) |
...
1. [要件定義フェーズ](./01-要件定義/ガイド.md) — 「何を作るか」を定義する
   - [requirements.md テンプレート](./01-要件定義/テンプレート.md) — コピーして使える実用テンプレート（Small / Medium / Large）
2. [設計仕様書フェーズ](./02-設計/ガイド.md) — 「どう作るか」を設計する
   - [設計仕様書テンプレート](./02-設計/テンプレート.md) — コピーして使える実用テンプレート（Small / Medium / Large）
3. [タスク分割フェーズ](./03-タスク分割/ガイド.md) — 実装タスクに分解する
   - [tasks.md テンプレート](./03-タスク分割/テンプレート.md) — コピーして使える実用テンプレート（Small / Medium / Large）
