...
| 2. Design | **どう作るか**を設計 | `design.md`, `data-model.md`, `contracts/` | [02-design/guide.md](./02-design/guide.md) |
| 3. Tasks | **どう分割するか**を計画 | `tasks.md` | [03-tasks/guide.md](./03-tasks/guide.md) |
| 4. Implementation | **実際に作る** | ソースコード | 実装フェーズ文書は未作成 |
...
2. [設計仕様書フェーズ](./02-design/guide.md) — 「どう作るか」を設計する
   - [設計仕様書テンプレート](./02-design/template.md) — コピーして使える実用テンプレート（Small / Medium / Large）
3. [タスク分割フェーズ](./03-tasks/guide.md) — 実装タスクに分解する
   - [tasks.md テンプレート](./03-tasks/template.md) — コピーして使える実用テンプレート（Small / Medium / Large）
4. 実装フェーズ — 仕様に沿って実装する（詳細ガイドは未作成）
